...
import { localDreaminaCancellationCopy } from "@/services/local-dreamina-task-projection";
...
export default function TasksPage() {
    ...
    const deleteLocalTask = (task: GenerationTask) => {
        ...
        const acceptedBackground = localDreaminaCancellationCopy(task)?.kind === "background";
        Modal.confirm({
            title: "删除本机任务记录？",
            content: acceptedBackground ? "任务已由官方接受；删除后仍会在后台同步官方状态。" : "这只会删除本机任务记录，不会删除已生成的素材。",
            okText: "删除本机记录",
