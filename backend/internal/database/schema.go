...
func Models() []any {
	return []any{
		...
		&model.FilmProductionQuote{},
		&model.FilmProductionAttempt{},
		&model.FilmProductionQCReport{},
		&model.FilmVisualQCQuote{},
		&model.FilmVisualQCAttempt{},
		&model.FilmVideoSequence{},
		&model.FilmVideoSlot{},
		&model.FilmVideoQuote{},
		&model.FilmVideoAttempt{},
		&model.FilmVideoQCReport{},
		&model.FilmVideoVisualQCQuote{},
		&model.FilmVideoVisualQCAttempt{},
		&model.FilmVideoSequenceVisualQCQuote{},
		&model.FilmVideoSequenceVisualQCAttempt{},
		&model.FilmVideoSequenceReview{},
		&model.FilmContinuityLedger{},
		&model.FilmContinuityShotState{},
		&model.FilmContinuityIssue{},
		&model.FilmReworkEvent{},
		&model.EcommerceArtifact{},
		&model.EcommercePresetVersion{},
		&model.EcommerceProductionRun{},
		&model.EcommerceProductionSlot{},
		&model.EcommerceProductionAttempt{},
		&model.EcommerceProviderEvaluationPlan{},
		&model.EcommerceProviderEvaluationAttempt{},
		&model.EcommerceProviderEvaluationScore{},
		&model.EcommerceProviderEvaluationPreference{},
		&model.CanvasProject{},
		&model.CanvasShare{},
...
func backfillAgentRuntimeLineage(db *gorm.DB) error {
	if !db.Migrator().HasTable(&model.AgentRuntimeRun{}) || !db.Migrator().HasTable(&model.AgentRoutingDecision{}) {
		return nil
	}
