# AI视频镜头提示词 参考：model / profiles/seedance / user / profile

## 本参考解决的问题

本条用于 `ai-video-shot-prompt` 的 `model / profiles/seedance / user / profile` 决策。它把专业判断落到可核对的字段，不替代项目事实源或 Human 决定。
